...
<x-livewire-powergrid::table-base class="dt-column-search table table-responsive dataTable" :theme="$theme->table">
    <x-slot name="header">
    ...
    <x-slot name="rows">
        <x-livewire-powergrid::inline-filters :makeFilters="$makeFilters" :checkbox="$checkbox" :actions="$actions" :columns="$columns"
            :theme="$theme" :filters="$filters" :enabledFilters="$enabledFilters" :inputTextOptions="$inputTextOptions" :tableName="$tableName"
            :setUp="$setUp" />
